...
def cria_grafo():
        ...
        G.add_edge("Armazem", "Gualtar", weight=6, estrada="terra", transito=0)
        G.add_edge("Gualtar", "SãoVitor", weight=4, estrada="alcatrao", transito=0)
        ...
        G.add_edge("Este", "Espinho", weight=5, estrada="paralelo", transito=0)
        G.add_edge("Este", "Tenões", weight=2, estrada="alcatrao", transito=0)
        G.add_edge("Espinho", "Nogueiró", weight=4, estrada="alcatrao", transito=0)
        ...
        G.add_edge("Lamaçães", "Nogueiró", weight=2, estrada="paralelo", transito=0)
        G.add_edge("Lamaçães", "Fraião", weight=1, estrada="terra", transito=0)
        G.add_edge("Tenões", "SãoVitor", weight=4, estrada="alcatrao", transito=0)
        G.add_edge("SãoVitor", "Fraião", weight=6, estrada="paralelo", transito=0)
        G.add_edge("SãoVitor", "Lamaçães", weight=4, estrada="alcatrao", transito=0)
        ...
        G.add_edge("SãoJoãoDoSouto", "SãoVicente", weight=3, estrada="terra", transito=0)
        G.add_edge("SãoJoãoDoSouto", "SãoLázaro", weight=4, estrada="terra", transito=0)
        ...
        G.add_edge("Tenões", "Gualtar", weight=4, estrada="paralelo", transito=0)
        G.add_edge("Este", "Gualtar", weight=4, estrada="alcatrao", transito=0)
        G.add_edge("Espinho", "Este", weight=5, estrada="paralelo", transito=0)
        G.add_edge("Tenões", "Este", weight=2, estrada="alcatrao", transito=0)
        G.add_edge("Nogueiró", "Espinho", weight=4, estrada="alcatrao", transito=0)
        G.add_edge("Nogueiró", "Tenões", weight=2, estrada="paralelo", transito=0)
        G.add_edge("SãoVitor", "Nogueiró", weight=8, estrada="alcatrao", transito=0)
        G.add_edge("Nogueiró", "Lamaçães", weight=2, estrada="paralelo", transito=0)
        G.add_edge("Fraião", "Lamaçães", weight=1, estrada="terra", transito=0)
        G.add_edge("SãoVitor", "Tenões", weight=4, estrada="alcatrao", transito=0)
        G.add_edge("Fraião", "SãoVitor", weight=6, estrada="paralelo", transito=0)
        ...
        G.add_edge("SãoLázaro", "SãoJoãoDoSouto", weight=4, estrada="terra", transito=0)
